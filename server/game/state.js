...
const ARENA_SIZE = 1750; // Logical units (increase as desired)
...
const BAND_SPRING_CONSTANT = 10.0;
...
class GameState {
  constructor() {
    ...
    const margin = 262.5; // Increase margin if you want bands further from border
    this.posts = [
      { x: margin, y: margin },
